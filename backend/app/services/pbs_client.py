...
class PBSClient:
    ...
    async def _request(self, method: str, path: str, **kwargs: Any) -> Any:
        async with httpx.AsyncClient(
            verify=settings.pbs_verify_ssl, timeout=30
        ) as client:
    ...
    async def create_namespace(self, datastore: str, namespace: str) -> dict[str, Any]:
        return await self._request(
            "POST", f"/admin/datastore/{datastore}/namespace",
            json={"name": namespace},
        )
    ...
    async def delete_namespace(
        ...
        return await self._request(
            "DELETE", f"/admin/datastore/{datastore}/namespace", params=params,
        )

    async def get_namespace_usage(self, datastore: str, namespace: str) -> dict[str, Any]:
        return await self._request(
            "GET", f"/admin/datastore/{datastore}/status", params={"ns": namespace},
        )

    # --- Backup Operations ---

    async def list_backups(
        self, datastore: str, namespace: str | None = None
    ) -> list[dict[str, Any]]:
        params: dict[str, str] = {}
        if namespace:
            params["ns"] = namespace
        return await self._request(
            "GET", f"/admin/datastore/{datastore}/snapshots", params=params,
        )

    async def delete_backup(
        self, datastore: str,
        backup_type: str, backup_id: str, backup_time: int,
        ...
        if namespace:
            params["ns"] = namespace
        return await self._request(
            "DELETE", f"/admin/datastore/{datastore}/snapshots", params=params,
        )
    ...
    async def list_backup_files(
        ...
        if namespace:
            params["ns"] = namespace
        return await self._request(
            "GET", f"/admin/datastore/{datastore}/files", params=params,
        )

    async def catalog_listing(
        self, datastore: str,
        backup_type: str, backup_id: str, backup_time: int,
        filepath: str, namespace: str | None = None,
    ) -> list[dict[str, Any]]:
        ...
        if namespace:
            params["ns"] = namespace
        return await self._request(
            "GET", f"/admin/datastore/{datastore}/catalog", params=params,
        )
    ...
    async def download_file(
        ...
        return await self._stream_request(
            "GET", f"/admin/datastore/{datastore}/pxar-file-download", params=params,
        )

    # --- Prune / Garbage Collection ---

    async def run_prune(
        self, datastore: str, namespace: str | None = None, **retention: Any
    ) -> dict[str, Any]:
        data: dict[str, Any] = {**retention}
        if namespace:
            data["ns"] = namespace
        return await self._request(
            "POST", f"/admin/datastore/{datastore}/prune", json=data,
        )
    ...
    async def verify_backup(
        self, datastore: str,
        backup_type: str, backup_id: str, backup_time: str,
    ) -> dict[str, Any]:
        return await self._request(
            "POST", f"/admin/datastore/{datastore}/verify",
            json={
                "backup-type": backup_type,
                "backup-id": backup_id,
                "backup-time": backup_time,
