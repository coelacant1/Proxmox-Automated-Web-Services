...
async def test_create_instance_type_admin(admin_client: AsyncClient):
    r = await admin_client.post("/api/instance-types/", json={
        "name": "paws.test",
        "vcpus": 2,
        "ram_mib": 2048,
        "disk_gib": 40,
...
async def test_create_instance_type_non_admin_forbidden(auth_client: AsyncClient):
    r = await auth_client.post("/api/instance-types/", json={
        "name": "paws.forbidden",
        "vcpus": 1,
        "ram_mib": 512,
        "disk_gib": 10,
...
async def test_create_duplicate_name_rejected(admin_client: AsyncClient):
    await admin_client.post("/api/instance-types/", json={
        "name": "paws.dup",
        "vcpus": 1,
        "ram_mib": 512,
        "disk_gib": 10,
...
async def test_update_instance_type(admin_client: AsyncClient):
    create = await admin_client.post("/api/instance-types/", json={
        "name": "paws.update",
        "vcpus": 1,
        "ram_mib": 512,
        "disk_gib": 10,
...
async def test_filter_by_category(admin_client: AsyncClient):
    await admin_client.post("/api/instance-types/", json={
        "name": "paws.gen.1",
        "vcpus": 1, "ram_mib": 512, "disk_gib": 10, "category": "general",
    })
    await admin_client.post("/api/instance-types/", json={
        "name": "paws.comp.1",
        "vcpus": 4, "ram_mib": 2048, "disk_gib": 20, "category": "compute",
    })
